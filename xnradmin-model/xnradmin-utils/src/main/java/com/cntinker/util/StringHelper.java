...
public class StringHelper {
	...
	public static Long getDayOfStart(Long time) {
		SimpleDateFormat datef = new SimpleDateFormat("yyyy-MM-dd");
		String t = datef.format(time) + " 00:00:00";
		Long res = null;
		try {
			res = datef.parse(t).getTime();
		} catch (java.text.ParseException e) {
			e.printStackTrace();
		}
		return res;
	...
	public static String getDayOfStartStr(Long time) {
		SimpleDateFormat datef = new SimpleDateFormat("yyyy-MM-dd");
		String t = datef.format(time) + " 00:00:00";
		return t;
	}

	public static Long getDayOfEnd(Long time) {
		SimpleDateFormat datef = new SimpleDateFormat("yyyy-MM-dd");
		String t = datef.format(time) + " 23:59:59";
		Long res = null;
		try {
			res = datef.parse(t).getTime();
		} catch (java.text.ParseException e) {
	...
	public static String getDayOfEndStr(Long time) {
		SimpleDateFormat datef = new SimpleDateFormat("yyyy-MM-dd");
		String t = datef.format(time) + " 23:59:59";
		return t;
	}
