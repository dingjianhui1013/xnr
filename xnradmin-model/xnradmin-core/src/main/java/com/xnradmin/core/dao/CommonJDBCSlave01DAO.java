 ...
 * @author: bin_liu
 */
@Repository("CommonJDBCSlave01DAO")
public class CommonJDBCSlave01DAO<T> extends BaseHibernateSlave01DAO{

    private static final Logger log = LoggerFactory
            .getLogger(CommonJDBCSlave01DAO.class);
    ...
    // public List findBySQLList(String sql,int pageNo,
    // int numPerPage,Object... obj){
    // SQLQuery sqlQuery = findBySQL(sql,pageNo,numPerPage);
