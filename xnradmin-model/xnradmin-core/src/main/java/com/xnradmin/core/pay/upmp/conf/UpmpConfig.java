package com.xnradmin.core.pay.upmp.conf;
...
public class UpmpConfig {
	...
	//private static final String CONF_FILE_NAME = SpringBase.getCfg().getWorklassPath() + "upmp.properties";
	
	private static final String CONF_FILE_NAME = "com/xnradmin/core/pay/upmp/conf/upmp.properties";
