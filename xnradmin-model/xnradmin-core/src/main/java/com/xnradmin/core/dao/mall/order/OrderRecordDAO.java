...
public class OrderRecordDAO{
    ...
    private static final Logger log = LoggerFactory
            .getLogger(OrderRecordDAO.class);
    ...
    public Serializable save(OrderRecord orderRecord){
        log.debug("saving OrderRecord instance");
        Serializable cls;
        try{
        	cls = commonDao.save(orderRecord);
    ...
    public OrderRecord findById(Long id){
        ...
        try{
            ...
            return (OrderRecord) commonDao.findById(
            		OrderRecord.class,id);
        }catch(RuntimeException re){
    ...
    public List<OrderRecord> findByExample(OrderRecord instance){
    ...
    public List findByProperty(String propertyName,Object value){
        log.debug("finding OrderRecord instance with property: "
                + propertyName + ", value: " + value);
        try{
            String queryString = "from OrderRecord as model where model."
                    + propertyName + "= ?";
    ...
    public List findAll(){
        log.debug("finding all OrderRecord instances");
        try{
            String queryString = "from OrderRecord";
    ...
    public OrderRecord merge(OrderRecord detachedInstance){
        ...
        try{
        	OrderRecord result = (OrderRecord) commonDao
    ...
    public int removeOrderRecordId(Long id){
        ...
        try{
            String queryString = "delete  from OrderRecord as model where model.id = "
                    + id;
    ...
    public static OrderRecordDAO getFromApplicationContext(
            ApplicationContext ctx){
        return (OrderRecordDAO) ctx.getBean("OrderRecordDAO");
    }
}