...
public class BaseService{
    ...
    public BaseService(String api) throws ClassNotFoundException, IllegalAccessException, InstantiationException, UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        apiURL = api;
//        Class c = Class.forName(Configure.HttpsRequestClassName);
//        serviceRequest = (IServiceRequest) new com.tencent.common.HttpsRequest();
    }
