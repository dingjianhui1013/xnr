...
import com.xnradmin.core.service.pay.wx.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest{
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(WXfInit.getCertLocalPath()));//加载本地的证书进行https加密传输
        try {
            keyStore.load(instream, WXfInit.getCertPassword().toCharArray());//设置证书密码
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, WXfInit.getCertPassword().toCharArray())
                .build();
