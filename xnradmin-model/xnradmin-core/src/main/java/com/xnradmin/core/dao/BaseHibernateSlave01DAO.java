 ...
 * @autohr: bin_liu
 */
@Transactional(value = "transactionManager_slave01", readOnly = false, propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class BaseHibernateSlave01DAO<T> {

	private static final Logger log = LoggerFactory
			.getLogger(BaseHibernateSlave01DAO.class);
	...
	@Resource(name = "sessionFactory_slave01")
