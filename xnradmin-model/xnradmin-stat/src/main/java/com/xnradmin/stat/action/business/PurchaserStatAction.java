...
import com.xnradmin.stat.service.business.PurchaserStatService;
...
public class PurchaserStatAction extends ParentAction {

	@Autowired
	private PurchaserStatService purchaserStatService;
	...
	static Log log = LogFactory.getLog(PurchaserStatAction.class);
	 ...
	 * @throws Exception 
	 */
	@Action(value = "purchaser", results = {
			@Result(name = StrutsResMSG.SUCCESS, location = "/stat/business/purchaser.jsp"),
			@Result(name = StrutsResMSG.FAILED, location = "/stat/business/purchaser.jsp") })
	public String purchaser() throws Exception {
		setPageInfo();
		return StrutsResMSG.SUCCESS;
	}

	private void setPageInfo() throws Exception {
		// 设置排序
		setDateTime();
		...
		if (staff != null && staff.getId() != null) {
			po.setStaffId(staff.getId().toString());
		}
		...
		// 商品和分类
		vo.setBusinessGoods(businessGoods);
		vo.setBusinessCategory(businessCategory);
		List list = purchaserStatService.findPurchaserStat(vo,
				0, 0);
...
//			content[2] = map.get("WEIGHT_NAME") == null ? "0" : map.get("WEIGHT_NAME").toString();
		...
		for (int i = 0; i < list.size(); i++) {
			...
			// 商户名称
			content[0] = map.get("STAFF_NAME") == null ? "" : map.get("STAFF_NAME").toString();
			content[1] = map.get("GOODS_NAME") == null ? "" : map.get("GOODS_NAME").toString();
			content[2] = map.get("CATEGORY_NAME") == null ? "" : map.get("CATEGORY_NAME").toString();
			content[3] = map.get("leadStaffName") == null ? "" : map.get("leadStaffName").toString();
			content[4] = map.get("n") == null ? "" : map.get("n").toString();
			content[5] = map.get("t") == null ? "" : map.get("t").toString();
			content[6] = map.get("p") == null ? "" : map.get("p").toString();
			BigDecimal b;
			if(content[5] != null && !content[5].equals("")){
				b = new BigDecimal(content[5]);
				content[5] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
			}
			if(content[6] != null && !content[6].equals("")){
				b = new BigDecimal(content[6]);
				content[6] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
			}
//			else if (a.length == 5) {
//				if (businessGoods != null && businessGoods.getId() != null) {
//					content[1] = a[1] == null ? "" : a[1].toString();
//					content[2] = "";
//					content[3] = "";
//					content[4] = a[2] == null ? "" : a[2].toString();
//					content[5] = a[3] == null ? "" : a[3].toString();
//					content[6] = a[4] == null ? "" : a[4].toString();
//					BigDecimal b = new BigDecimal(content[5]);
//					content[5] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//					b = new BigDecimal(content[6]);
//					content[6] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//				} else if (businessCategory != null
//						&& businessCategory.getId() != null) {
//					content[1] = "";
//					content[2] = a[1] == null ? "" : a[1].toString();
//					content[3] = "";
//					content[4] = a[2] == null ? "" : a[2].toString();
//					content[5] = a[3] == null ? "" : a[3].toString();
//					content[6] = a[4] == null ? "" : a[4].toString();
...
//					b = new BigDecimal(content[6]);
//					content[6] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//				} else if (leaderStaff != null && leaderStaff.getId() != null) {
//					content[1] = "";
//					content[2] = "";
//					content[3] = a[1] == null ? "" : a[1].toString();
//					content[4] = a[2] == null ? "" : a[2].toString();
//					content[5] = a[3] == null ? "" : a[3].toString();
//					content[6] = a[4] == null ? "" : a[4].toString();
//					BigDecimal b = new BigDecimal(content[5]);
...
//						&& businessCategory.getId() != null) {
//					content[1] = a[1] == null ? "" : a[1].toString();
//					content[2] = a[2] == null ? "" : a[2].toString();
//					content[3] = "";
//					content[4] = a[3] == null ? "" : a[3].toString();
//					content[5] = a[4] == null ? "" : a[4].toString();
//					content[6] = a[5] == null ? "" : a[5].toString();
//					BigDecimal b = new BigDecimal(content[5]);
//					content[5] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//					b = new BigDecimal(content[6]);
//					content[6] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//				} else if (businessGoods != null
//						&& businessGoods.getId() != null && leaderStaff != null
//						&& leaderStaff.getId() != null) {
//					content[1] = a[1] == null ? "" : a[1].toString();
//					content[2] = "";
//					content[3] = a[2] == null ? "" : a[2].toString();
//					content[4] = a[3] == null ? "" : a[3].toString();
//					content[5] = a[4] == null ? "" : a[4].toString();
//					content[6] = a[5] == null ? "" : a[5].toString();
//					BigDecimal b = new BigDecimal(content[5]);
...
//				} else if (businessCategory != null
//						&& businessCategory.getId() != null
//						&& leaderStaff != null && leaderStaff.getId() != null) {
//					content[1] = "";
//					content[2] = a[1] == null ? "" : a[1].toString();
//					content[3] = a[2] == null ? "" : a[2].toString();
//					content[4] = a[3] == null ? "" : a[3].toString();
...
//				content[1] = a[1] == null ? "" : a[1].toString();
//				content[2] = a[2] == null ? "" : a[2].toString();
//				content[3] = a[3] == null ? "" : a[3].toString();
//				content[4] = a[4] == null ? "" : a[4].toString();
//				content[5] = a[5] == null ? "" : a[5].toString();
//				content[6] = a[6] == null ? "" : a[6].toString();
//				BigDecimal b = new BigDecimal(content[5]);
//				content[5] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
//				b = new BigDecimal(content[6]);
//				content[6] = b.setScale(2, java.math.BigDecimal.ROUND_HALF_UP).toString();
