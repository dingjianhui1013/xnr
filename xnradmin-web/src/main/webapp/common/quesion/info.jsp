...
<%
	...
	String action = basePath + "page/log/info.action";
	String modify = basePath+"page/log/modifyInfo.action";
	String del =  basePath+"page/log/del.action";
	String add =  basePath+"page/log/addInfo.action";
