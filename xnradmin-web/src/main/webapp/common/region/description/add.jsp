...
<%
	...
	String actionForm = basePath+"page/Common/Region/Description/add.action";	
...
<div class="pageContent">
	<form method="post" action="${actionForm}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>所属街/路：</label>
				<input id="road_id" class="readonly" name="roadtype.id" readonly="readonly" type="hidden"/>
				<input readonly="readonly" name="roadtype.road" type="text"/>	
				<a class="btnLook" href="${roadLookup}?provinceid={province_id}&cityid={city_id}&areaid={area_id}" lookupGroup="roadtype">查找带回</a>	
			</p>
			<p>
				<label>社区：</label>
				<input id="community_id" class="readonly" name="communitytype.id" readonly="readonly" type="hidden"/>
				<input readonly="readonly" name="communitytype.community" type="text"/>	
			...
			<p>
				<label>具体描述：</label>
				<input name="description" type="text" size="30" alt="请输入具体描述" class="required"/>
			</p>
		</div>
		<div class="formBar">
			<ul>				
