...
<%
	...
	String action = basePath+"page/Common/Region/Description/lookup.action";
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						...
						<td>
							<input type="radio" name="description" value="{id:'${loop.descriptionid}', description:'${loop.province}${loop.city}${loop.area}${loop.road}${loop.community}${loop.description}'}"/>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
