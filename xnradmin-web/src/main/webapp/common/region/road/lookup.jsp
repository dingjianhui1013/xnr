...
<%
	...
	String action = basePath+"page/Common/Region/Road/lookup.action";
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>街/路名称:</label>
				<input class="textInput" name="road" value="" type="text">
			</li>	  
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						...
						<td>${loop.road}</td>
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.roadid}', road:'${loop.road}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
