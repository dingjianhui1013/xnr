...
<%
	...
	String getCbm = basePath+"page/Common/Region/Road/all.action";
	String actionForm = basePath+"page/Common/Region/Road/modify.action";
...
<div class="pageContent">
	<form method="post" action="${actionForm}" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>街/路名称：</label>
				<input id="road_id" name="roadid" readonly="readonly" value="${roadid}" type="hidden"/>
				<input name="road" type="text" size="30" value="${road}" class="required"/>
			</p>
		</div>
		<div class="formBar">
			<ul>				
