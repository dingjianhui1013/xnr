...
<%
	...
	String actionForm = basePath+"page/Common/Region/Area/add.action";	
...
<div class="pageContent">
	<form method="post" action="${actionForm}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>所属城市：</label>
				<input class="readonly" name="citytype.id" readonly="readonly" type="hidden"/>
			...
			<p>
				<label>区/县名称：</label>
				<input name="area" type="text" size="30" alt="请输入区/县名称" class="required"/>
			</p>
		</div>
		<div class="formBar">
			<ul>				
