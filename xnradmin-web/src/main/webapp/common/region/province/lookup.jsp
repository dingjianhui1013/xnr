...
<%
	...
	String action = basePath+"page/Common/Region/Province/lookup.action";
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						...
						<td>${loop.province}</td>
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.provinceid}', province:'${loop.province}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
