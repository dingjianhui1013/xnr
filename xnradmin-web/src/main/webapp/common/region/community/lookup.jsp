...
<%
	...
	String action = basePath+"page/Common/Region/Community/lookup.action";
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>社区名称:</label>
				<input class="textInput" name="community" value="" type="text">
			</li>	  
		...
		<tbody>
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						<td>${loop.communityid}</td>
						<td>${loop.community}</td>
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.communityid}', community:'${loop.community}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
