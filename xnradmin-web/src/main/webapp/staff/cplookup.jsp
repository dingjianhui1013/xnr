...
<%
	...
	String action = basePath + "page/staff/cplookup.action?orgid=1";	
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr target="sid_queryid" rel="${loop.userid}">
						...
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({cpid:'${loop.userid}', cpName:'${loop.staffName}', orgNum:'${loop.userid}'})" title="查找带回">选择</a>
						</td>						
					</tr>
				</c:forEach>
			</c:if>		
