...
<%
	...
	String actionForm = basePath
			+ "page/WashCarProductRule/batchAdd.action";
	String productLookup = basePath
			+ "page/WashCarProduct/lookup.action";
	String statusLookup = basePath
			+ "page/WashCarProductRule/statusLookup.action";
	String ruleTypeLookup = basePath
			+ "page/WashCarProductRule/maxTypeLookup.action";
	String descriptionLookup = basePath
			+ "page/Common/Region/Description/batchLookup.action";
			...
			<div class="tabs">
				<div class="tabsHeader">
					<div class="tabsHeaderContent">
						<ul>
							<li class="selected"><a href="javascript:void(0)"><span>批量添加规则</span></a></li>
						</ul>
					</div>
				</div>
				<div class="tabsContent">
					<div>
						<table class="list nowrap itemDetail" addButton="添加规则" width="100%">
							<thead>
								<tr>
