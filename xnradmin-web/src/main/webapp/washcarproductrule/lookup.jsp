...
<%
	...
	String action = basePath+"page/CarBrandModels/lookup.action";
	String add = basePath+"page/CarBrandModels/addinfo.action";
	String modify = basePath+"page/CarBrandModels/modifyinfo.action";
	String del = basePath+"page/CarBrandModels/del.action";
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>产品名称:</label>
				<input class="textInput" name="productName" value="" type="text">
			</li>	  
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						...
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.washcarproductid}', productName:'${loop.productname}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
