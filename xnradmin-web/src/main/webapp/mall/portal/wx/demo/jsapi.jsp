...
<%
	...
	String notifyUrl = "http://api.weixin.qq.com/cgi-bin/pay/delivernotify?access_token="
			+ tokenId;
%>
...
<script Language="javascript">
            ...
            {
                return "a398c60b3f0b846773897307d3d19c6d";
            }
            ...
            function getPackage()
            {
                ...
                var notify_url = "http://admin.17xnr.com/mall/portal/wx/demo/payack.jsp";//支付成功后将通知该地址
...
<script language="javascript">
			...
			jQuery('a#getBrandWCPayRequest').click(function(e){
						...
						var paySign = getSign();
						var out = "appId:"+appId+" | timeStamp:"+timeStamp+" | nonceStr:"
							+nonceStr+" | pkg:"+pkg+" | signType:"+signType
							+" | paySign:"+paySign;
						alert("out : "+out);
						$('#out').val(out);
...
<body>
	...
	<form name="form1" target="_blank">
		<table border="1">
			<TR>
				<th>公众号ID</th>
				<th><INPUT value="<%=APP_ID%>" name="appId" id="1"></th>
			<tr>
				<th>商户ID</th>
			...
			<tr>
				<textarea  rows="30" cols="15" id="out"></textarea></tr>
		</table>
	</form>
	<div class="WCPay">
