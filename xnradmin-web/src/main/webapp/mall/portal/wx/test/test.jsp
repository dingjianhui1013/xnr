...
<%
	...
	String appSecret = "2600d40d93b689670c2f2de19b18212e";
	String transid = String.valueOf(System.currentTimeMillis()); //模拟一个交易号
	String access_token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
	String PARTNER = "1220311401";
	String PARTNER_KEY	= "a398c60b3f0b846773897307d3d19c6d";	//财付通密钥
	String openid="ohmUCjzaoZzX6gTX3CxDO2B-LfE4";
	
	WXAccessTokenService accessTokenService = (WXAccessTokenService) SpringBase
			.getCtx().getBean("WXAccessTokenService");

	WXAccessToken tk = accessTokenService.findByWxuserId(1l, false);
	String tokenId = tk.getAccessToken();
	System.out
			.println("http://api.weixin.qq.com/cgi-bin/pay/delivernotify?access_token="
					+ tokenId);
%>
<!DOCTYPE html>
<html>
...
orderNo = encrypt;
            ...
            function getPackage()
            {
				...
				var notify_url = "http://www.51xnr.com/mall/portal/wx/payack.jsp";//这个地址是支付成功后调用的，业务系统需要在这里截获返回的参数，写到自己的业务系统中以记录此订单是否成功付款，及付款银行信息等很多内容，详见支付接口文档。
...
// alert('getAppId start......')
            ...
            function getAppKey()
            {
                return "zzybkXgAi2InoZX49yKFhBIn3vBUixHFLjztqOjkM5i0rJzQ2y9fYPAVpPAKXbrNcsn55vfBXE5J51tZ12stVpW5WAw4vaE6QNkkiGYyXM5xwzJOXvhXpbsb3A5vRsE5";//很长很长，支付专用签名串PaySignKey，如果没有，跟微信客服索取（得走完微信支付审批流程）。
            }
...
<body>
	...
	<form name="form1" target="_blank">
		<table border="1">
			<TR>
				<th>公众号ID</th>
				<th><INPUT value="<%=appId%>" name="appId" id="1"></th>
			<tr>
				<th>商户ID</th>
				<th><INPUT value="<%=PARTNER%>" name="partnerId" id="2"></th>
			<TR>
				<th>总金额</th>
				<th><INPUT value=1 name="totalFee" id="3"></th>
			<TR>
				<th>商品名</th>
				<th><INPUT value="手表" name="body" id="4"></th>
		</table>
	</form>
