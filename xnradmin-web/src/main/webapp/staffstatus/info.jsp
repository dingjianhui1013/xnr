...
<%
	...
	String action = basePath+"page/staffStatus/info.action";
	String all = basePath+"page/staffStatus/all.action";
	String modify = basePath+"page/staffStatus/modifyinfo.action";
	String add = basePath+"staffstatus/add.jsp";
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" href="${modify}?queryid={sid_queryid}" target="navTab" rel="modify" warn="请选择一个状态"><span>修改</span></a></li>
