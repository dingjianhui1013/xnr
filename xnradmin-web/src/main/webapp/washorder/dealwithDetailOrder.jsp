...
<%
	...
	String reStartOrder = basePath + "page/order/dealWithSendOrder.action";
	request.setAttribute("staffLookup", staffLookup);
	request.setAttribute("reStartOrder", reStartOrder);
%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<div class="pageContent">
	<div class="pageFormContent" layoutH="56">
		<form action="${reStartOrder}" class="pageForm required-validate"
			...
			<p>
				<label>终止理由:</label>${vo.stopDesc}
			</p>
			<p>
				<label>指派技师:</label>
				<input class="readonly" name="staffVO.userid"
					readonly="readonly" value="${vo.washerId}" type="hidden" /> <input
					class="readonly" name="staffVO.mobile" readonly="readonly"
					value="${vo.washerMobile}" type="hidden" /> <input
					readonly="readonly" name="staffVO.staffName"
					value="${vo.washerName}" type="text" class="required" /> <a
					class="btnLook" href="${staffLookup}" lookupGroup="staffVO">查找带回</a>
			</p>
