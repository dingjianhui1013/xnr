...
<%
	...
	String action = basePath + "page/order/finish.action";
	String view = basePath + "page/order/finishView.action";
...
<div class="pageContent">
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr>
						...
						<td><a title="详情" rel="portView" target="dialog"
							href="${view}?carWashOrderRecordId=${loop.carWashOrderRecordId}"
							class="btnLook">详情</a></td>
					</tr>
				</c:forEach>
			</c:if>
		</tbody>
	...
	<div class="panelBar">
		<div class="pages">
			...
			</select> <span>条，共${totalCount}条</span> <span>&nbsp;&nbsp;&nbsp;结算金额：${sumMoney}元</span>
		</div>
