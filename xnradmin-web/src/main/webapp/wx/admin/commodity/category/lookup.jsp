...
<%
	...
	String action = basePath+"page/wx/admin/commodity/category/lookup.action";
		...
		<tbody>
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr target="sid_categoryId" rel="${loop.categoryId}">					
						...
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.categoryId}', 
							categoryLevel:'${loop.categoryLevel}', categoryName:'${loop.categoryName}', 
							primaryConfigurationId:'${loop.categoryPrimaryConfigurationId}'})" title="查找带回">选择</a>
						</td>
					</tr>				
				</c:forEach>
			</c:if>
