...
<%
	...
	String actionForm = basePath + "page/wx/admin/commodity/category/modify.action";
...
<div class="pageContent">
	...
	<form method="post" action="${actionForm}" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this)">
		...
		<input name="categoryId" value="${categoryId}" type="hidden"/>
			<p>
				<label>分类名称：</label>
				<input name="categoryName" type="text" size="25" value="${categoryName}" class="required"/>
			</p>
			<p>
				<label>分类图片：</label>
			...
			<p>
				<label>选择父类：</label>
				<input class="readonly" name="categoryParent.id" value="${categoryParentId}" readonly="readonly" type="hidden"/>
				<input class="readonly" name="categoryParent.categoryLevel" value="${categoryLevel}" readonly="readonly" type="hidden"/>
				<input class="readonly" name="categoryParent.primaryConfigurationId" value="${primaryConfigurationId}" readonly="readonly" type="hidden"/>
			...
			<p>
				<label>描述：</label>
				<input name="categoryDescription" value="${categoryDescription}" type="text" size="25" />
			</p>
			<p>
				<label>分类状态：</label>
			...
			<p>
				<label>排序：</label>
				<input name="categorySortId" type="text" size="25" value="${categorySortId}" class="required number"/>
			</p>
		</div>
		<div class="formBar">
			<ul>				
