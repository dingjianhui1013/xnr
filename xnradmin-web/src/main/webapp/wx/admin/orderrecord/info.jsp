...
<%
	...
	String action = basePath+"page/wx/admin/orderrecord/info.action";
	String add = basePath+"page/wx/admin/orderrecord/addinfo.action";
	String modify = basePath+"page/wx/admin/orderrecord/modifyinfo.action";
	String del = basePath+"page/wx/admin/orderrecord/del.action";
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="${del}?orderRecordId={sid_orderRecordId}&del=1" target="ajaxTodo" title="删除某个订单"><span>删除</span></a></li>
		</ul>
	</div>
			...
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr target="sid_orderRecordId" rel="${loop.orderRecordId}">						
						...
						<td>					
							<a title="编辑" target="navTab" href="${modify}?orderRecordId=${loop.orderRecordId}" class="btnEdit">编辑</a>
							<!-- 
							<a title="删除" target="ajaxTodo" href="${del}?orderRecordId=${loop.orderRecordId}&del=1" class="btnDel">删除</a>
							 -->
						</td>	
					</tr>				
				</c:forEach>
