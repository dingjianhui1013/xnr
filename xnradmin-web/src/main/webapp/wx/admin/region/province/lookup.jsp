...
<%
	...
	String action = basePath+"page/wx/admin/region/province/lookup.action";
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>省份名称:</label>
				<input class="textInput" name="province" value="" type="text">
			</li>	  
			...
			<c:if test="${poList!=null}">
				<c:forEach items="${poList}" var="loop">
					<tr>
						...
						<td>${loop.province}</td>
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.id}', province:'${loop.province}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
