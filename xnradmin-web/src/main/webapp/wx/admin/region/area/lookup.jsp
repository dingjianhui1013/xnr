...
<%
	...
	String action = basePath+"page/wx/admin/region/area/lookup.action";
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>区/县名称:</label>
				<input class="textInput" name="area" value="" type="text">
			</li>	  
...
<div class="pageContent">
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		<thead>
			<tr>
				<th width="100">区/县ID</th>
				<th width="100">区/县名称</th>			
				<th width="80">查找带回</th>
			</tr>
		</thead>
		<tbody>
			<c:if test="${poList!=null}">
				<c:forEach items="${poList}" var="loop">
					<tr>
						<td>${loop.id}</td>
						<td>${loop.area}</td>
						<td>
							<a class="btnSelect" href="javascript:$.bringBack({id:'${loop.id}', area:'${loop.area}'})" title="查找带回">选择</a>
						</td>
					</tr>					
				</c:forEach>
			</c:if>			
