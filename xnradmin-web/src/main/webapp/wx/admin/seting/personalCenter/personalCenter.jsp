								...
								<div class="d-planList">
									<form action="">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<p class="form-control-static outputDate">
													<span>${outplan.goodsId }</span>
												</p>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<p class="form-control-static outputDate">
													<span><fmt:formatDate value="${outplan.startTime }"
															pattern="yyyy-MM-dd "></fmt:formatDate></span>至<span><fmt:formatDate
															value="${outplan.endTime }" pattern="yyyy-MM-dd "></fmt:formatDate></span>
												</p>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<p class="form-control-static outputDate">
													<span>${outplan.output }${outplan.unitId }
												</p>
											</div>
										</div>
									</form>
