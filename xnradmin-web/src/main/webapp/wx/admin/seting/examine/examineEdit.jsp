...
<body>
	<div class="wrapper">
		<div class="header">
			<span class="titleBox">商户审核修改</span>
		</div>
		<div class="contentBox">
			<form id="form" role="form" action="<%=path %>/page/wx/farmer/updateFarmerExamine.action" method="post">
				<div class="form-group">
					...
					<div class="col-sm-11">
						...
						<input type="hidden" value="${farmerExamine.id}"  name="farmerExamine.id" id="farmerExamineId"/>
					</div>
				...
				<div class="btnBox">
					<button type="button" onclick="validation()" class="btn btn-success" id="sub">确认修改</button>
				</div>
			</form>
