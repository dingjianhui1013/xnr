...
<%
	...
	String action = basePath+"page/stat/order/dishCount.action";
	...
	<div class="searchBar">	
		<table class="searchContent">
			<tr>
				<td>
					订单ID：
					<input type="text" name="orderRecordIdorderNo" value="${orderRecordId}"/>
				</td>
				<td>
					订单编号：
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="158">
		<thead>
			<tr>
				<th width="100" align="center">菜品名称</th>
				<th width="100" align="center">菜品数量</th>
			</tr>
		</thead>
		<tbody>		
