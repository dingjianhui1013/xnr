...
<div class="pageContent">
	<table class="table" width="100%" layoutH="65">
		...
		<tbody>
			 <c:if test="${businessOrderVOList!=null}">
				<c:forEach items="${businessOrderVOList}" var="loop" varStatus="status">
					<tr target="sid_comboUserId" rel="${loop.businessOrderRecord.id}">
