...
<%
	...
	String action = basePath+"page/business/admin/orderrecord/add.action";
	String goodsLookup = basePath+"page/business/admin/commodity/goods/lookup.action?goodsStatus=192";
...
<div class="pageContent">
	<form method="post" action="${action}" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<c:choose>
			...
			<p><label>配送时间：</label>
				<input type="text" name="requiredDeliveryTime" yearstart="-80" yearend="1"  dateFmt="yyyy-MM-dd" value="${userRealTime}" class="date" readonly="true" />
			</p>
			<p><label>支付方式：</label>
			...
			<fieldset>
				<legend>备注：</legend>
				<dl class="nowrap">
					<dd><textarea name="userRealDescription" cols="60" rows="5"></textarea></dd>
				</dl>
			</fieldset>
			<fieldset>
				<legend>订单总价：</legend>
