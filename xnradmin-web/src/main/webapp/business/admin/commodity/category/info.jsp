...
<%
	...
	String action = basePath+"page/business/admin/commodity/category/info.action";
	String add = basePath+"page/business/admin/commodity/category/addinfo.action";
	String modify = basePath+"page/business/admin/commodity/category/modifyinfo.action";
	String del = basePath+"page/business/admin/commodity/category/del.action";
		...
		<tbody>
			<c:if test="${voList!=null}">
				<c:forEach items="${voList}" var="loop">
					<tr target="sid_categroyId" rel="${loop.businessCategory.id}">					
						...
						<c:if test="${businessCategoryList!=null}">
							<c:forEach items="${businessCategoryList}" var="categoryAll">
						...
						<td>					
							<a title="编辑" target="navTab" href="${modify}?categoryId=${loop.businessCategory.id}" class="btnEdit">编辑</a>
							<a title="删除" target="ajaxTodo" href="${del}?categoryId=${loop.businessCategory.id}&del=1" class="btnDel">删除</a>
						</td>	
					</tr>				
				</c:forEach>
			</c:if>			
